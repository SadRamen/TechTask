...
public class Projectile : MonoBehaviour {
	...
	private void OnCollisionEnter (Collision collision)
	{
		...
		IHaveProjectileReaction projectileReaction = collision.gameObject.GetComponent<IHaveProjectileReaction>();


		if (projectileReaction != null)
		{
			projectileReaction.Reaction(collision);
		}
		if (!destroyOnImpact) 
		{
